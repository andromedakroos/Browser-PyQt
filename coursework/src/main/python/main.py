...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        save_file_action.setStatusTip("Save to file")
        save_file_action.triggered.connect(self.save_file)
        self.file_menu.addAction(save_file_action)
        
        about_action = QAction(QIcon(os.path.join('data/images', 'question.png')), "About Andrew Browser", self)
    ...
    def update_title(self, browser):
        ...
        self.setWindowTitle("%s Andrew Browser" % title)
    ...
    def save_file(self):
        filename, _ = QFileDialog.getSaveFileName(self, "Save page as", "",
                                                        ...
                                                        "All files (*.*)")
        if filename:
            html = self.tabs.currentWidget().toHtml()
...
if __name__ == '__main__':
    ...
    app.setApplicationName("Andrew Browser")
    window = MainWindow()
